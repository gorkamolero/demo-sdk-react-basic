...
const Switch = ({checked = true, onChange}) => {
  ...
  return (
    <label className="switch" style={{ fontFamily: textstyles.bodyLarge }}>
      ...
      <span className="switch-label" data-on="Subscribe &amp; Save 20%" data-off="One-Time Purchase" style={{ fontFamily: textstyles.bodyLarge, backgroundColor: colors.hbGoldLight }}>
      </span> 
