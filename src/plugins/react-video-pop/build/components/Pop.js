    ...
    function Pop() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Pop.__proto__ || Object.getPrototypeOf(Pop)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
            ...
            rest: {
                ...
                y: window.innerHeight - (300 * (_this.props.ratio.h / _this.props.ratio.w) + 10 + HbFooterSize)
            },
            scale: 0,
            ...
            if (dimensions.w <= window.innerWidth / 2 && dimensions.w >= 300) {
                if (_this.dim.x + dist < 300) {
                    ...
                    _this.setState({
                        ...
                        pos: {
                            x: pos.x,
                            y: window.innerHeight - (h + 10  + HbFooterSize)
                        },
                        rest: {
                            x: pos.x,
                            y: window.innerHeight - (h + 10  + HbFooterSize)
                    ...
                    _this.setState({
                        ...
                        pos: {
                            x: pos.x,
                            y: window.innerHeight - (_h5 + 10 + HbFooterSize)
                        },
                        rest: {
                            x: pos.x,
                            y: window.innerHeight - (_h5 + 10 + HbFooterSize)
                    ...
                    _this.setState({
                        ...
                        pos: {
                            x: pos.x,
                            y: window.innerHeight - (_h6 + 10 + HbFooterSize)
                        },
                        rest: {
                            x: pos.x,
                            y: window.innerHeight - (_h6 + 10 + HbFooterSize)
            ...
            if (dimensions.w <= window.innerWidth / 2 && dimensions.w >= 300) {
                if (_this.dim.x + dist < 300) {
                    ...
                    _this.setState({
                        ...
                        pos: {
                            x: window.innerWidth - (window.innerWidth / 2 + 10),
                            y: window.innerHeight - (_h7 + 10 + HbFooterSize)
                        },
                        rest: {
                            x: window.innerWidth - (window.innerWidth / 2 + 10),
                            y: window.innerHeight - (_h7 + 10 + HbFooterSize)
                    ...
                    _this.setState({
                        ...
                        pos: {
                            x: window.innerWidth - (_this.dim.x + dist + 10),
                            y: window.innerHeight - (_h8 + 10 + HbFooterSize)
                        },
                        rest: {
                            x: window.innerWidth - (_this.dim.x + dist + 10),
                            y: window.innerHeight - (_h8 + 10 + HbFooterSize)
                ...
                if (e.clientX >= window.innerWidth / 2 && e.clientY >= window.innerHeight / 2) {
                    _this.setState({
                        rest: {
                            ...
                            y: window.innerHeight - (height + 10 + HbFooterSize)
                        },
                        popCoordinate: 'br',
                        popTranslate: {
                            top: '0px',
